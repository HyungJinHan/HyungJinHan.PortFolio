...
export default function BackGroundShapes({}: Props) {
  return (
    ...
    >
      <div className="rounded-full border border-[#37b3ed] h-[200px] w-[200px] absolute mt-52 animate-ping" />
      ...
      <div className="rounded-full border border-[#37b3ed] h-[650px] w-[650px] absolute mt-52 opacity-20 animate-pulse" />
