...
export default function Moogle({}: Props) {
  return (
        ...
        <h4 className="text-4xl font-semibold max-sm:font-bold max-sm:text-2xl text-center -mb-[20px]">
          ...
          <span className="text-lg">
            <a
              ...
              href="https://github.com/HyungJinHan/OpenAPI_Toy_Project"
              target="_blank"
            >
              Toy Project Moogle GitHub
            </a>
            <span className="px-2">|</span>
            <a
              className="underline text-[#37b3ed]/50 text-lg hover:text-[#37b3ed] transition duration-300 ease-in-out"
              href="https://hyungjinhan.notion.site/Moggle-4ecea3f30dbe431b8d688afcc12b1f8b"
              target="_blank"
            >
